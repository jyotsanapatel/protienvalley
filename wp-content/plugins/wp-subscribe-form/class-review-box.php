<?php
class Subscribe_form_review_box {
    ...
    public function admin_notices() {
        ...
        <div class="notice notice-info premio-notice <?php echo esc_attr($this->plugin_slug) ?>-premio-review-box <?php echo esc_attr($this->plugin_slug) ?>-premio-review-box">
            <div class="review-box-default" id="default-review-box-<?php echo $this->plugin_slug ?>">
                ...
                <ul>
                    <li><a class="<?php echo esc_attr($this->plugin_slug) ?>-premio-review-box-hide-btn" href="https://wordpress.org/support/plugin/wp-subscribe-form/reviews/?filter=5" target="_blank">I'd love to help :)</a></li>
...
$Subscribe_form_review_box = new Subscribe_form_review_box();