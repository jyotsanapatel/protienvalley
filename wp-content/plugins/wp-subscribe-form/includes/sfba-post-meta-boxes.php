...
function sfba_shortcode_meta_box_UI( $post ){
	...
	<input type="text" readonly id="sfba_shortcode_value" name="sfba_shortcode_value" value="[arrow_forms id='<?php echo $post->ID; ?>']" />
	<p id="sfba_shortcode_label" >To add Subscribe Form into your Widget area use this shortcode:</p>
	<input type="text" readonly style="font-size: 14px;" id="sfba_shortcode_value" name="sfba_widget_shortcode_value" value="[arrow_forms id='<?php echo $post->ID; ?>' widget='true']" />
	<?php
}
			...
			<table>
				<tr>
					...
					<div id="sfba_mail_selection" style="display: none;">
						...
						<input type="email" id="sfba_sent_to_email" name="sfba_sent_to_email" value="<?php echo $sfba_sent_to_email; ?>" placeholder="name@domain.com" />
					</div>
						...
						?>
					        ...
					        <select name="sfba_mailchimp_lists">
							    ...
							    ?>
							    <option value="<?php echo $id; ?>" <?php selected( $selected_mc_service, $id ); ?>><?php echo $name; ?></option>
							    <?php
								}
							?>
					        </select>
						...
						if (isset($get_gr_lists) && $get_gr_lists =='') {
					        ...
					        <select name="sfba_getresponse_lists">
							    ...
							    $name  = $list->sfba_service_list_name;
							    ?>
							    <option value="<?php echo $id; ?>" <?php selected( $selected_gr_service, $id ); ?>><?php echo $name; ?></option>
							    <?php
								}
							?>
					        </select>
						...
						<div id="sfba_activecampaign_selection" style="display: none;">
					        ...
					        <select name="sfba_activecampaign_lists">
							    ...
							    $name  = $list->sfba_service_list_name;
							    ?>
							    <option value="<?php echo $id; ?>" <?php selected( $selected_ac_service, $id ); ?>><?php echo $name; ?></option>
							    <?php
								}
							?>
					        </select>
...
<p readonly id="sfbap_shortcode_value" name="sfbap_shortcode_value" style="text-align: ;">
	Step 3: Save Form & Copy this shortcode and paste into your post or page where you want to show the form </br>        <span id="sfba-subscribe-shortcode">[arrow_forms id='<?php echo $post->ID; ?>']</span>
