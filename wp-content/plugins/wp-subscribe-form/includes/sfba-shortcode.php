...
function sfba_arrow_forms_shortcode($atts , $content){
	...
	if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform1') {
		...
		<link href="https://fonts.googleapis.com/css?family=<?php echo $form_fonts;?>:400,600,700" rel="stylesheet" type="text/css" class="sfba-google-font">
		<?php endif;?>
		<style>
			#sfba_subscribe_form_<?php echo $sfba_post_fix; ?> #sfba-form2-container{
				width: <?php echo $form_width;?>px;
				border: <?php echo $border_size; ?>px <?php echo $border_style; ?> <?php echo $border_color; ?>;
				font-family: '<?php echo $form_fonts;?>';
				display: block;
				text-align: center;
			...
			#sfba_subscribe_form_<?php echo $sfba_post_fix; ?> .subscribeform1_sub_heading {
			    margin: 0;
			    color: <?php echo $form_sub_heading_color; ?>;
			    font-size: 14px;
			    line-height: 21px;
			    font-family: inherit;
			}
			#sfba_subscribe_form_<?php echo $sfba_post_fix; ?> #sfba-form2-container #sfba-form2-heading {
			    margin: 0 0 10px;
			    line-height: 48px;
			    font-weight: bold;
			    font-size: 32px;
			...
			#sfba_subscribe_form_<?php echo $sfba_post_fix; ?> .sfba_subscribe_form__fields .sfba-form2-fields {
				width: 100%;
				box-shadow: none;
				padding-left: 15px;
				margin-top: 8px;
				...
				border: 1px solid <?php echo $field_border_color; ?>;
				border-radius: 0;
				color: #7E7E7E;
				height: 32px;
				font-weight: 400;
			...
			#sfba_subscribe_form_<?php echo $sfba_post_fix; ?> .sfba-form2-consent-fields-main {
			    text-align: left;
			    margin: 12px auto 5px;
			    color: <?php echo $form_consent_color; ?>;
		        line-height: 1;
			}
			...
			#sfba_subscribe_form_<?php echo $sfba_post_fix; ?> #sfba-form2-button {
			    width: 100%;
			    display: block;
			    border: none;
			    margin-top: 10px;
		...
		<form id="sfba_subscribe_form_<?php echo $sfba_post_fix; ?>" class="sfba_subscribe_form" action="" method="POST">
			<div id="sfba-form2-container" class="sfba-main-form-container <?php echo $sfba_subscribe_form . ' sfba-attention-effect-' . $attention_effect; ?>">
				<p class="subscribeform1_sub_heading"><?php echo $form_sub_heading;?></p>
				<h2 id="sfba-form2-heading"><?php echo $form_heading;?></h2>
				<div class="sfba_subscribe_form__fields_wrap">
					<div class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">
						...
						<?php endif;?>
							<input id="sfba-form2-email" name="sfba-form-email" class="sfba-form2-fields sfba-form-email" type="email" value="" placeholder="<?php echo $email_placeholder; ?>">
					</div>
					<?php if ( $consent_on == 'yes' ) { ?>
						<p class="sfba-form2-consent-fields-main">
							<label>
								<input type="checkbox" name="sfba-form2-consent-field" value="1" />
								<span><?php echo $form_conset_field;?></span>
							</label>
						</p>					
					...
					<input type="submit" id="sfba-form2-button" data-form-id="sfba_subscribe_form_<?php echo $sfba_post_fix; ?>" class="sfba-form-submit-button" value="<?php echo $button_text;?>" />
				</div>
				<div id="sfba_thanks_container" class="sfba_thanks_container" style="display:none;">
					<a href="javascript:void(0);" class="sfba-form-close" data-form-id="sfba_subscribe_form_<?php echo $sfba_post_fix; ?>">x</a>
					<div>
			...
			<input type='hidden' id='sfba_post_type_id' class="sfba_post_type_id" name="sfba_post_type_id" value="<?php echo $id; ?>" />
		</form>
		<?php 
	}
	...
	if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform2') {
		...
		?>
		<link href="https://fonts.googleapis.com/css?family=<?php echo $form_fonts;?>:400,600,700" rel="stylesheet">
		<style>
		...
		<form id="sfba_subscribe_form" action="" method="POST">
			<div id="sfba-form3-container">
				<div class="sfba-form2-login-block">
					...
					<p id="sfba_form2_subheading" ><?php echo $form_sub_heading; ?></p>
					<div class="sfba_subscribe_form__fields_wrap">
						<div class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">
						...
						<?php if ( $consent_on == 'yes' ) { ?>
							<p class="sfba-form3-consent-fields-main">
								<label>
									<input type="checkbox" name="sfba-form2-consent-field" value="1" />
									<span class="subscribeform2_consent_txt"><?php echo $form_conset_field;?></span>
								</label>
							</p>					
						...
						<?php }?>
						<input type="submit" class="sfba-form-submit-button" data-form-id="sfba_subscribe_form" id="sfba-form3-button" value="<?php echo $button_text; ?>" />
					</div>
				</div>
		...
		<input type='hidden' id='sfba_post_type_id' name="sfba_post_type_id" value="<?php echo $id; ?>" /> 
		<?php
	}
	...
	if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform3') {
		...
		<form id="sfba_subscribe_form" action="" method="POST" >
			<div id="sfba-form2-container" class="sfba-main-form-container">
				<div id="sfba-form3-container">
					<h2 id="sfba-form3-heading1"><?php echo $form_heading; ?></h2>
					<p id="sfba-form3-heading2"><?php echo $form_sub_heading; ?></p>
					<div class="sfba_subscribe_form__fields">
						<input type="email" id="sfba-form3-email-text" name="sfba-form-email" class="sfba-form-email" value="" placeholder="Your Email">
						<input type="submit" id="sfba-form3-button" data-form-id="sfba_subscribe_form" class="sfba-form-submit-button" name="" value="<?php echo $button_text; ?>">
					</div>
					<?php if ( $consent_on == 'yes' ) { ?>
						<p class="sfba-form3-consent-fields-main">
							<label>
								<input type="checkbox" name="sfba-form3-consent-field" value="1" />
								<span class="subscribeform3_consent_txt"><?php echo $form_conset_field;?></span>
							</label>
						</p>					
	...
	if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform4') {
		...
		<form id="sfba_subscribe_form" action="" method="POST">
			<div id="sfba-form4-container" class="sfba-main-form-container">
				<h2 id="sfba-form4-heading"><?php echo $form_heading; ?></h2>
				<p id="sfba-form4-subheading"><?php echo $form_sub_heading; ?></p>
				<div class="input">
					<input id="sfba-form4-email" type="email" class="sfba-button sfba-form-email" name="sfba-form-email" placeholder="Your email id">
					<input type="submit" class="sfba-button sfba-form-submit-button" data-form-id="sfba_subscribe_form" id="submit" value="<?php echo $button_text; ?>">					
				</div>
				<?php if ( $consent_on == 'yes' ) { ?>
					<p class="sfba-form4-consent-fields-main">
						<label>
							<input type="checkbox" name="sfba-form4-consent-field" value="1" />
							<span class="subscribeform4_consent_txt"><?php echo $form_conset_field;?></span>
						</label>
					</p>					
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform5') {
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form5-wrapper" class="sfba-main-form-container">
			<h2 id="sfba-form5-heading" name="sfba-form5-heading"><?php echo $form_heading; ?></h2>
			<p id="sfba-form5-subheading" name="sfba-form5-subheading"><?php echo $form_sub_heading; ?></p>
			<div class="sfba_subscribe_form__fields_wrap">
				<div class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">
				...
				<?php if ( $consent_on == 'yes' ) { ?>
					<p class="sfba-form5-consent-fields-main">
						<label>
							...
							<span class="subscribeform5_consent_txt"><?php echo $form_conset_field;?></span>
						</label>
					</p>					
				...
				<?php }?>
				<input type="submit" class="submit sfba-form-submit-button" data-form-id="sfba_subscribe_form" value="<?php echo $button_text; ?>">
			</div>
			<div id="sfba_thanks_container" style="display:none;">
				<div>
					<p id="sfba_thanks_image"><img src="<?php echo plugins_url('../images/tick.png',__FILE__);?>"></p>
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform6') {
	...
	if( get_post_meta($id, '_sfba-form6-sub-heading-color', true) !='' )
		...
		$form_sub_heading_color = 'rgba(255,255,255,0.8)';
	?>
	<link href="https://fonts.googleapis.com/css?family=<?php echo $form_fonts;?>:400,500,600,700" rel="stylesheet">
	<style>
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form7-container" class="sfba-main-form-container">
			<div id="sfba-form6-container">
				<h2 id="sfba-form6-heading1"><?php echo $form_heading; ?></h2>
				<p id="sfba-form6-heading2"><?php echo $form_sub_heading; ?></p>
				<div class="sfba_subscribe_form__fields">
					<input type="email" id="sfba-form6-email-text" name="" class="sfba-form-email" value="" placeholder="Your Email">					
					<input type="submit" class="sfba-form-submit-button" data-form-id="sfba_subscribe_form" id="sfba-form6-button" name="" value="<?php echo $button_text; ?>">
				</div>
				<?php if ( $consent_on == 'yes' ) { ?>
					<p class="sfba-form6-consent-fields-main">
						<label>
							<input type="checkbox" name="sfba-form6-consent-field" value="1" />
							<span class="subscribeform6_consent_txt"><?php echo $form_conset_field;?></span>
						</label>
					</p>					
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform7') {
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form7-container" class="sfba-main-form-container">
			<h2 id="sfba-form7-heading"><?php echo $form_heading; ?></h2>
			<p id="sfba-form7-subheading"><?php echo $form_sub_heading; ?></p>
			<div class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">
			...
			<?php if ( $consent_on == 'yes' ) { ?>
				<p class="sfba-form7-consent-fields-main">
					<label>
						...
						<span class="subscribeform7_consent_txt"><?php echo $form_conset_field;?></span>
					</label>
				</p>					
			...
			<?php }?>
			<input type="submit" value="<?php echo $button_text; ?>" data-form-id="sfba_subscribe_form" name="subscribe" id="sfba-form7-button" class="btn btn__bottom--border mailchimp__btn sfba-form-submit-button" >
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform8') {
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form9-newsletter" class="newsletter-grid newsletter-clearfix sfba-main-form-container" >
			<h2 id="sfba-form9-heading"><?php echo $form_heading; ?></h2>
			<p class="subscribeform8_sub_heading"><?php echo $form_sub_heading; ?></p>
			...
			<div class="controls-container">
				<?php if ( $consent_on == 'yes' ) { ?>
					<p class="sfba-form8-consent-fields-main">
						<label>
							...
							<span class="subscribeform8_consent_txt"><?php echo $form_conset_field;?></span>
						</label>
					</p>					
				...
				<?php }?>
				<input id="sfba-form-submit-button" class="sfba-form-submit-button" data-form-id="sfba_subscribe_form" type="submit" value="<?php echo $button_text; ?>" />
			</div>
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform9') {
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form9-newsletter" class="sfba-main-form-container">
			<h2 id="sfba-form9-heading" class="title"><?php echo $form_heading; ?></h2>
    		<p id="sfba-form9-subheading"><?php echo $form_sub_heading; ?></p>
			<div id="sfba-form9-fields-elements" class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">
			...
			<?php if ( $consent_on == 'yes' ) { ?>
				<p class="sfba-form9-consent-fields-main">
					<label>
						<input type="checkbox" name="sfba-form9-consent-field" value="1"/>
						<span class="subscribeform9_consent_txt"><?php echo $form_conset_field;?></span>
					</label>
				</p>					
				<p class="sfba-form9-fields sfba-conset-field-error error" style="display:none !important; color:#ff0606;"><?php echo wp_kses('Please select "'. $form_conset_field .'" option.', array());?></p>
			<?php }?>
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform10') {
	...
	if( get_post_meta($id, '_sfba-form10-sub-heading-color', true) !='' )
		...
		$form_sub_heading_color = '#FFFFFF';
	?>
	<link href="https://fonts.googleapis.com/css?family=<?php echo $form_fonts;?>:400,500,700" rel="stylesheet">
	<style>
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form10-container" class="sfba-main-form-container">
			<h2 id="sfba-form10-heading"><?php echo $form_heading; ?></h2>
			<p id="sfba-form10-subheading"><?php echo $form_sub_heading; ?></p>
			<div class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">
			...
			<?php if ( $consent_on == 'yes' ) { ?>
				<p class="sfba-form10-consent-fields-main">
					<label>
						...
						<span class="subscribeform10_consent_txt"><?php echo $form_conset_field;?></span>
					</label>
				</p>					
			...
			<?php }?>
			<input id="sfba-form-submit-button" class="sfba-form-submit-button" data-form-id="sfba_subscribe_form" type="submit" value="<?php echo $button_text; ?>" name="button"/>
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform11') {
	...
	<form id="sfba_subscribe_form" action="" method="POST">
		<div id="sfba-form11-container" class="sfba-main-form-container">
			<h2 id="sfba-form11-heading"><?php echo $form_heading; ?></h2>
			<p id="sfba-form11-subheading"><?php echo $form_sub_heading; ?></p>
			<div class="sfba_subscribe_form__fields_wrap">
				<div class="sfba_subscribe_form__fields <?php if ($display_name != 'yes'): echo $sfba_subscribe_fields_class; else: echo 'sfba-form-email-full'; endif;?>">
				...
				<input id="sfba-form11-button" type="submit" data-form-id="sfba_subscribe_form" class="sfba-form-submit-button" value="<?php echo $button_text; ?>">
			</div>
			<?php if ( $consent_on == 'yes' ) { ?>
				<p class="sfba-form11-consent-fields-main">
					<label>
						<input type="checkbox" name="sfba-form11-consent-field" value="1"/>
						<span class="subscribeform11_consent_txt"><?php echo $form_conset_field;?></span>
					</label>
				</p>					
...
if (!empty($sfba_subscribe_form) && $sfba_subscribe_form == 'subscribeform12') {
	...
	?>	
	<link href="https://fonts.googleapis.com/css?family=<?php echo $form_fonts;?>" rel="stylesheet">
	<style>
		...
		#sfba-form12-container #sfba-form12-name {
			font-family: '<?php echo $form_fonts;?>' !important;
		}
		...
		#sfba-form12-name{
		    ...
		    border: 1px solid <?php echo $email_border_color; ?>;
		...
		<div id="sfba-form12-container" class="sfba-main-form-container">
			...
			<?php if ( $consent_on == 'yes' ) { ?>
				<p class="sfba-form12-consent-fields-main">
					<label>
						<input type="checkbox" name="sfba-form12-consent-field" value="1" style="width: 20px !important;"/>&nbsp;<?php echo $form_conset_field;?>
					</label>
				</p>					
