...
<div id="sfba-form1-options-contaner" class="sfba-form-options-contaner">
	<table>
		...
		<tr id="sfba-form-email-placeholder">
			...
			<td>
				<input type="text" id="sfba-form1-email-placeholder" class="sfba-form-email-placeholder" name="sfba-form1-email-placeholder" value="<?php echo $email_placeholder; ?>" placeholder="Enter Email Placeholder" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="sfba-form1-email-required-msg" class="sfba-form-email-required-msg" name="sfba-form1-email-required-msg" value="<?php echo $email_required_msg; ?>" placeholder="Enter Email Rrquired Message" />
			</td>
		</tr>
		<?php if ( $display_name != 'yes'):?>
		...
		<tr>
			...
			<td>
				<input type="number" id="sfba-form1-width" class="sfba-form-width" name="sfba-form1-width" value="<?php echo $form_width; ?>" placeholder="Form Width (px)" /> 
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<select name="sfba-form1-fonts" class="sfba-form-fonts">
					...
					<?php $group= ''; foreach( sfba_fonts() as $key=>$value):  
							...
							?>
						<option value="<?php echo $key;?>" <?php selected( $sfba_form1_fonts, $key ); ?>><?php echo $key;?></option>		
					<?php endforeach;?>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="sfba-form1-heading" class="sfba-form-main-heading" name="sfba-form1-heading" value="<?php echo $form_heading; ?>" />
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<input type="text" id="sfba-form1-sub-heading" class="sfba-form-sub-heading" name="sfba-form1-sub-heading" value="<?php echo $form_sub_heading; ?>" />
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<input type="text" id="sfba-form1-subscribe-button-text" class="sfba-form-subscribe-button" name="sfba-form1-subscribe-button-text" value="<?php echo $button_text; ?>" />
			</td>
		</tr>		
		<tr>
			<td>
			...
			<td>
				<input type="number" id="sfba-form1-border-size" class="sfba-form-border-size" name="sfba-form1-border-size" value="<?php echo $border_size; ?>" min="0" placeholder="Border Width Size (px)" /><br/>
		...
		<tr>
			...
			<tr>
				...
				<td>
					<input type="number" id="sfba-form1-button-text-size" class="sfba-form-subscribe-btn-txt-size" name="sfba-form1-button-text-size" value="<?php echo $button_text_size; ?>" placeholder="Test Size (px)" />
				</td>
			</tr>
			<tr>
				<td>
