...
<form id="sfba_subscribe_form" action="" method="POST">
	<div id="sfba-form2-container" class="sfba-main-form-container subscribeform1 sfba-attention-effect-<?php echo $attention_effect; ?>">
		<p class="subscribeform1_sub_heading"><?php echo $form_sub_heading;?></p>
		<h2 id="sfba-form2-heading" class="subscribeform1_heading"><?php echo $form_heading;?></h2>
		<div class="sfba_subscribe_form__fields_wrap">
			<div class="sfba_subscribe_form__fields <?php echo $sfba_subscribe_fields_class;?>">			
				...
				<input id="sfba-form2-email" name="sfba-form-email" class="sfba-form2-fields sfba-form-email subscribeform1_form_email" type="email" value="" placeholder="<?php echo $email_placeholder; ?>">
			</div>
			<p id="sfba-consent-fields-main" class="sfba-form2-consent-fields-main" <?php if ($consent_on != 'yes'):?> style="display: none;" <?php endif;?>>
				<label>
					...
					<span class="subscribeform1_consent_txt"><?php echo $form_conset_field;?></span>
				</label>
			</p>
			<input type="submit" id="sfba-form2-button" class="sfba-form-submit-button subscribeform1_subscribe_btn subscribeform_subscribe_btn" value="<?php echo $button_text;?>" />
		</div>
